    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseAdmin" class="collapse show" aria-labelledby="headingAdmin" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="pengolahan-meja-admin.php">Pengolahan Meja</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Pengolahan Meja</h1>
            </div>

            <!-- Tabel Pengolahan Meja -->
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Meja Baru</h6>
                        </div>
                        <div class="card-body">
                            <form action="pengolahan-meja-tambah-admin.php" method="POST">
